...
static const int VFS_MAX_ENTRIES  = 64;
static const int VFS_MAX_PATH     = 128;
static const int VFS_MAX_FILESIZE = 4096;
...
struct VFSEntry {
    ...
    uint32_t start_lba;              // Sector number on disk
    uint32_t sector_count;           // How many sectors it uses
